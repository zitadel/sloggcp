...
We currently support the following version of sloggcp:
...
* You think you discovered a ...
  * ... potential security vulnerability in sloggcp
  * ... vulnerability in another project that sloggcp bases on
...
All accepted and mitigated vulnerabilities will be published on the [Github Security Page](https://github.com/zitadel/sloggcp/security/advisories)
